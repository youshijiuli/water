...
def load_local_mnist(
    x_train_path=os.path.dirname(__file__) + "/train-images-idx3-ubyte.gz",
    y_train_path=os.path.dirname(__file__) + "/train-labels-idx1-ubyte.gz",
    x_test_path=os.path.dirname(__file__) + "/t10k-images-idx3-ubyte.gz",
    y_test_path=os.path.dirname(__file__) + "/t10k-labels-idx1-ubyte.gz",
    normalize=True,
    one_hot=True,
):
    ...
    """
    image = {"train": __read_image(x_train_path), "test": __read_image(x_test_path)}

    label = {"train": __read_label(y_train_path), "test": __read_label(y_test_path)}
